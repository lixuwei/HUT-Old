...
public class Xslq {
	...
	private double zzllcj;
	private double wgycj;
	private double ywk1cj;
	private double ywk2cj;
	private double zf;
	private double fscj;
	private String js1mc;
	private double js1cj;
	private String js2mc;
	private double js2cj;
	...
	public int getHkszdm() {
		return hkszdm;
	}
	public void setHkszdm(int hkszdm) {
		this.hkszdm = hkszdm;
	}
	...
	public int getLqdwdm() {
		return lqdwdm;
	}
	public void setLqdwdm(int lqdwdm) {
		this.lqdwdm = lqdwdm;
	}
	...
	public String getBydwmc() {
		return bydwmc;
	}
	public void setBydwmc(String bydwmc) {
		this.bydwmc = bydwmc;
	}
	...
	public int getKslydm() {
		return kslydm;
	}
	public void setKslydm(int kslydm) {
		this.kslydm = kslydm;
	}
	public int getKsfsdm() {
		return ksfsdm;
	}
	public void setKsfsdm(int ksfsdm) {
		this.ksfsdm = ksfsdm;
	}
	...
	public int getDaszdwyzbm() {
		return daszdwyzbm;
	}
	public void setDaszdwyzbm(int daszdwyzbm) {
	...
	public void setZzllm(int zzllm) {
		this.zzllm = zzllm;
	}
	...
	public double getZzllcj() {
		return zzllcj;
	}
	public void setZzllcj(double zzllcj) {
		this.zzllcj = zzllcj;
	}
	public double getWgycj() {
		return wgycj;
	}
	public void setWgycj(double wgycj) {
		this.wgycj = wgycj;
	}
	public double getYwk1cj() {
		return ywk1cj;
	}
	public void setYwk1cj(double ywk1cj) {
		this.ywk1cj = ywk1cj;
	}
	public double getYwk2cj() {
		return ywk2cj;
	}
	public void setYwk2cj(double ywk2cj) {
		this.ywk2cj = ywk2cj;
	}
	public double getZf() {
		return zf;
	...
	public double getFscj() {
		return fscj;
	}
	public void setFscj(double fscj) {
		this.fscj = fscj;
	}
	...
	public double getJs1cj() {
		return js1cj;
	}
	public void setJs1cj(double js1cj) {
		this.js1cj = js1cj;
	}
	...
	public double getJs2cj() {
		return js2cj;
	}
	public void setJs2cj(double js2cj) {
		this.js2cj = js2cj;
	}
	...
	public void setZxjh(int zxjh) {
		this.zxjh = zxjh;
	}
	public int getXszgzc() {
		return xszgzc;
	}
	public void setXszgzc(int xszgzc) {
		this.xszgzc = xszgzc;
	}
	...
	public void setSzssm(int szssm) {
		this.szssm = szssm;
	}
	public String getBz() {
		return bz;
	...
	public double getFscjqz() {
		return fscjqz;
	}
	public void setFscjqz(double fscjqz) {
		this.fscjqz = fscjqz;
	}
	public int getNf() {
		return nf;
